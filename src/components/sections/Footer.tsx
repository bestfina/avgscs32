  ...
  return (
    <footer className="bg-[#0E202C] text-white" id="contact">
      <div className="container">
        {/* Upper Section */}
        <div className="flex flex-wrap justify-between py-16 gap-8 lg:py-12 md:py-10 md:flex-wrap md:gap-x-6 md:[&>div]:mb-4 sm:py-8 sm:flex-col">
          <div className="flex-1 min-w-[200px] max-w-[300px] md:min-w-[45%] md:max-w-[45%] sm:max-w-none sm:mb-6">
            <Logo big light />
          </div>

          <div className="flex-1 min-w-[200px] max-w-[250px] md:min-w-[45%] md:max-w-[45%] sm:max-w-none sm:mb-6">
            <h3 className="text-[20px] font-semibold text-white mb-4 leading-tight sm:text-[18px] md:text-end sm:text-start sm:mb-4" style={{ fontFamily: "var(--font-nunito)" }}>
        ...
        <div className="flex flex-wrap justify-between py-8 gap-8 lg:py-8 md:py-6 md:flex-wrap md:gap-x-6 md:[&>div]:mb-4 sm:py-4 sm:flex-col">
          ...
          <div className="flex-1 min-w-[200px] max-w-[250px] md:min-w-[45%] md:max-w-[45%] md:text-end sm:text-start sm:max-w-none sm:mb-6">
            <h3 className="text-[18px] font-semibold text-white mb-1 leading-tight sm:text-[16px] sm:mb-2" style={{ fontFamily: "var(--font-nunito)" }}>
          ...
          <div className="flex-1 min-w-[200px] max-w-[250px] md:min-w-[45%] md:max-w-[45%] sm:max-w-none sm:mb-6 sm:flex sm:justify-center">
            <button
              ...
              className="flex items-center justify-center gap-3 bg-transparent text-white text-[16px] hover:opacity-[0.7] transition-opacity duration-300 sm:text-[18px] bg-[#263641] px-[20px] rounded-lg h-[60px] md:h-[50px] md:text-[15px] sm:h-[60px] sm:text-[18px] w-full text-start"
            >
        ...
        {/* Bottom Section */}
        <div className="w-full flex flex-wrap justify-between py-16 gap-8 lg:py-12 md:py-8 md:flex-wrap md:gap-x-6 md:[&>div]:mb-4 sm:py-8 sm:flex-col border-t border-[#FFFFFF33] relative">
          <div className="w-full flex flex-wrap justify-between items-center gap-6 sm:flex-col sm:gap-4 sm:items-start">
            <div className="order-1 sm:order-3 flex-1 min-w-[200px] max-w-[300px] md:min-w-[45%] md:max-w-[45%] sm:max-w-none sm:mb-3 sm:w-3/5">
            ...
            <div className="order-2 flex-1 min-w-[200px] max-w-[250px] md:min-w-[45%] md:max-w-[45%] sm:max-w-none sm:mb-3 sm:w-1/2 md:text-end sm:text-start">
              <TransitionLink
                href="/privacy"
            ...
            <div className="order-3 sm:order-1 flex-1 min-w-[200px] max-w-[250px] md:min-w-[45%] md:max-w-[45%] sm:max-w-none sm:mb-3 sm:w-3/5">
              <TransitionLink
                href="/"
                className="text-[16px] text-[#FFFFFF99] hover:text-white transition-colors duration-300 leading-relaxed sm:text-[14px]"
              >
            ...
            <div className="order-4 flex w-full justify-end min-w-[250px] max-w-[300px] md:min-w-[45%] md:max-w-[45%] sm:max-w-none sm:absolute sm:bottom-10 sm:right-[3px]">
              <FirstSection
                withIcon
