  ...
  return (
    ...
    >
      {FEEDBACKS.map(({ id, name, avatar, poster, video }) => (
        <SwiperSlide key={id}>
          <div className="flex flex-col border border-TextDark rounded-3xl h-[650px] xxl:h-[550px] xl:h-[600px] lg:h-[480px] md:h-[550px] sm:h-[480px] xs:h-[480px] overflow-hidden">
