  ...
  return (
    <PopupProvider>
      <TransitionRouter
        ...
        leave={(next, from, to) => {
          setCurrentPathName(
            (to?.replace(/^\//, "").replace(/-/g, " ") || "not-found") as keyof typeof ROUTE_TRANSLATE
          );
          const tl = gsap
            .timeline({
              onComplete: next,
      ...
      >
        ...
        >
          <div ref={textRef} className="text-white text-5xl font-extrabold opacity-0 font-press uppercase x:text-2xl md:text-3xl">
